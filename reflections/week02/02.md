...
- What is the ShellShocked Attack?
  - a vulnerability that allows systems containing a vulnerable version of Bash to be exploited to execute commands with higher privileges
- How can you ensure your environment is protected from ShellShocked?
  - closed-loop verification and the ability to manage patches across multiple platforms from a single point of control
- Identify at least 1 takeaway from today's assignment
  - Python is superior to Bash.